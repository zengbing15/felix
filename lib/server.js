...
const { RPC, Reader,normalizers } = require("ckb-js-toolkit");
...
const STATE_MACHINE = {
  ...
  [DATA_PAY_SIGNING]: async (session, msg, reply) => {
    ...
    // generate serialized unsignedtransaction Json file
  ...
  const INPUT_TX_HASH = "0xdbb96ebbc23b04ca63aef0eab409072e2f71d6d7d8b2437aaac3cb98211884e2";
  const input_txs = (await rpc.get_transaction(INPUT_TX_HASH)).transaction;
   
  const CELL_DEP_TX_HASH = "0xf8de3bb47d055cdf460d93a2a6e1b05f7432f9777c8c474abf4eec1d4aee5d37";
  ...
  const serializedUnsignedTx = new Reader(
    ...
    console.log(typeof serializedUnsignedTx);
